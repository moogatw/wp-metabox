(function($){
	...
	$(document).ready(function(){
		...
		$('.mcc-box__9 .radio').click(function(e){
				$('.mcc-box__9 .radio.select9').removeClass('select9');
				$(this).addClass('select9');
		});

		$('.mcc-box__10 .radio').click(function(e){
				$('.mcc-box__10 .radio.select10').removeClass('select10');
